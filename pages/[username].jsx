...
export default function AccountPage() {
  ...
  return (
    <>
      <div className='grid grid-cols-1 md:grid-cols-[1fr_2fr] m-5 mt-20 md:m-20 md:gap-20'>
        <AccountCard accountUser={account_user_data} currentUser={current_user_data} className=""/>
        {current_user_data.id === account_user_data.id && (
          <div className="flex flex-col gap-2 justify-center items-center py-10 max-h-fit ">
            { 
